<header class="h-svh max-h-svh w-full">
    <div class="relative">
        ...
        <div class="bg-linear-to-t absolute inset-x-0 bottom-0 h-2/4 from-black to-transparent"></div>
        <div class="bg-linear-to-b absolute inset-x-0 top-0 h-1/4 from-black/50 to-transparent"></div>
