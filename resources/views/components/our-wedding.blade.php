    ...
    <div class="flex w-full flex-col gap-y-6 text-center">
        <div class="w-fit self-center" data-observe>
            <h2 data-class-in="visible translate-y-0 opacity-100" data-class-out="invisble translate-y-20 opacity-0"
                class="font-italianno duration-750 translate-y-20 transform text-5xl text-black opacity-0 transition-all delay-300 ease-in-out lg:text-6xl">
                Our Wedding
            </h2>
        </div>
        <div class="self-center">
            <div class="max-w-2xl" data-observe>
                <p class="duration-750 translate-y-20 transform text-sm opacity-0 transition-all delay-300 ease-in-out sm:text-base"
