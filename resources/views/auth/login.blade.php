        ...
        <main class="mx-auto flex min-h-screen max-w-screen-xl flex-col place-content-center gap-4 px-6">
            ...
            <div class="grid w-full grid-cols-2 shadow-sm">
                ...
                <div
                    ...
                    <form action="{{ route('login') }}" method="POST" class="mt-15 space-y-4">
                        @csrf
                        <div class="relative">
                        ...
                        <div class="relative">
                            ...
                            <div
                                class="pointer-events-none absolute inset-y-0 start-0 flex items-center ps-2 peer-disabled:pointer-events-none peer-disabled:opacity-50">
                                <x-lucide-key-round class="size-5 shrink-0 text-gray-500" />
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="">
                                <a href=""
                                    class="text-sm text-blue-600 hover:text-blue-700 hover:underline">Forgot
                                    Password?</a>
                            </div>
                        </div>
                        <button type="submit"
                    ...
                    <div class="mt-6 flex justify-center">
                        <span class="text-sm text-gray-500">Don't have an account yet?
